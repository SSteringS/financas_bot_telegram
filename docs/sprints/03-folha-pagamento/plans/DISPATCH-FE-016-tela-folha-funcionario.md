...
> **Quando usar:** após BE-028 E FE-015 **ambas mergeadas** em `develop`.
...
```
git log origin/develop --oneline | grep -E "be-028|fe-015"
```
...
1. Branch: `feature/fe-016-tela-folha-funcionario` saindo de `origin/develop`
...
10. NÃO mergeie. PR pra develop após status report + Reviewer.
