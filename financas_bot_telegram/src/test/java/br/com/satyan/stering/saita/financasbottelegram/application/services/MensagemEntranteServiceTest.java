...
class MensagemEntranteServiceTest {
    ...
    private PaymentMessageDTO dto(Long chatId) {
        return PaymentMessageDTO.builder().chatId(chatId).caption("qualquer").build();
    }
    ...
    void deveDespacharParaAPrimeiraStrategyQueSuportar() {
        ...
        MensagemEntranteService service = new MensagemEntranteService(List.of(strategyA, strategyB));
    ...
    void deveLancarInvalidMessageFormatExceptionComListaVazia() {
        ...
        MensagemEntranteService service = new MensagemEntranteService(List.of());
